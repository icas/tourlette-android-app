...
import com.example.placesapi.model.Request;
import com.example.placesapi.model.response.JSONResponse;
import com.example.placesapi.model.response.Response;
...
public class ApiConnection {
    ...
    public Response performRequest(Request request) {
        ...
        try{
            ...
            Log.e("ICAS-PROGRAM", e.toString());
        }
        Log.e("ICAS-PROGRAM", response.toString());
